...
このときのゲーム ![image](https://user-images.githubusercontent.com/25688193/38077329-98022a0a-3373-11e8-8f5b-736bec810575.png) の唯一のナッシュ均衡点は、(D, D) である。<br>
...
- 戦略の組 (all-C, all-C) は、割引因子 δ の値に関わらず、ナッシュ均衡点である。<br>
- 割引因子 δ ≥ 1/9 のとき、<br>
