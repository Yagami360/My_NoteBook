...
以下の定理で示すように、L1ノルムは、μ-可積分な関数全体の集合に、完備性を持つ（＝コーシー列が収束する）距離を導入する。<br>
...
>【Memo】<br>
> ”L1ノルムは、μ-可積分な関数全体の集合に、完備性を持つ（＝コーシー列が収束）距離を導入する。これをL1空間の完備化という。”の意味での完備の条件は、<br>
> - 測度空間が、完備であることの条件は、「任意の零集合の部分集合が、また零集合である」<br>
> の意味での完備の条件と結びつく？（L1空間は測度空間なので、どっちも同じ完備の条件を示しているはず？）
