...
### ◎ StyleGAN のアーキテクチャ
![image](https://user-images.githubusercontent.com/25688193/57284185-9f13a100-70eb-11e9-8fcc-8523266e709d.png)<br>
...
- 各解像度スケールでの Adaptive Instance Normalization (AdaIN) の採用：<br>
    ...
    ※ 詳細は、「[【補足】 Style Transfer における正規化手法]()」 の項目を参照）<br>

    ![image](https://user-images.githubusercontent.com/25688193/57304335-17915680-711a-11e9-8e75-7aceef4809d7.png)<br>
    ...
    そして、この AdaIn による変換を、各解像度スケール（4×4、8×8、16×16、・・・、1024×1024）の畳み込みの直後に行う。<br>
    これにより、各解像度スケール（4×4、8×8、16×16、・・・、1024×1024）度に、スタイル（画風）を変化させることが出来るようになる。<br>
