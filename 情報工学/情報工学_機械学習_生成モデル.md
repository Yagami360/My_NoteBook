...
- GANimaton は、心理学で用いられている顔の表情表現である Facial Action Coding System (FACS) の知見と、条件付き GAN（cGAN）を拡張したものを組み合わせることで、1つの画像から自動的に表情をアニメートすることを実現している。
...
- GANimation の利点：<br>
    ...
    これにより生成画像において、背景や照明条件が変化しても、最もらしい表情アニメーションが生成でき、この点において SOTA を超えている。
...
このような写像 M を実現するために、GANimation では下図のようなアーキテクチャを構成している。<br>
...
- 生成器のアーキテクチャ：<br>
    ...
    - 双方向 [bidirectionally] の構造を持つ：<br>
        ...
        ※ 更に、それぞれの過程で、後述の attention mask と color mask 用の生成器の２つが存在するので、合計４つの生成器が存在することになる。
...
### ◎ GANimation の損失関数
GANimation の損失関数は、以下の４つの損失関数の線形結合によって表現される。

![image](https://user-images.githubusercontent.com/25688193/58852642-4e836980-86d2-11e9-856e-6cee4f50ab3b.png)
...
2. attention loss：<br>
    ![image](https://user-images.githubusercontent.com/25688193/58853176-47f5f180-86d4-11e9-8bfc-dc2efee665ac.png)<br>
    ![image](https://user-images.githubusercontent.com/25688193/58852837-0c0e5c80-86d3-11e9-89e6-7983b5fe52ba.png)<br>
...
3. conditional expression loss：<br>
    ![image](https://user-images.githubusercontent.com/25688193/58854046-29452a00-86d7-11e9-938a-89ae3fc942bb.png)<br>
    特定の表情に対応したAUs 状態ベクトルの目標ベクトル y_g で条件付けされて生成された、生成器からの出力画像 ![image](https://user-images.githubusercontent.com/25688193/58854181-7fb26880-86d7-11e9-8f1a-60c6b0aadae2.png) が、対応する AUs 状態ベクトル y ̂_g  に正しく回帰（![image](https://user-images.githubusercontent.com/25688193/58854140-65788a80-86d7-11e9-8066-140a611b79c9.png)）するようにするための損失関数。<br>
