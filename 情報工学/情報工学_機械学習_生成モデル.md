...
1. Inpainting
    1. 【非公開】Pluralistic-Inpainting [Pluralistic Image Completion]
1. 顔特化系（Face Swap, etc）
    ...
    1. [FaceGAN] Semi-supervised Adversarial Learning to Generate Photorealistic Face Images of New Identities from 3D Morphable Model
    1. On Face Segmentation, Face Swapping, and Face Perception
    1. 
1. 仮想試着システム [Virtual Try-On]
    1. [【非公開】CP-VTON [Characteristic-Preserving Virtual Try-On Network]](#https://github.com/Yagami360/My_Notebook_Private/blob/master/cp-vton.md)
1. [補足事項](#補足事項)
