...
### ◎ 既存のGAN（＝JSダイバージェンス最小化での学習）の問題点
概略で挙げたように、従来のGANにはいくつかのが問題点が存在するが、以下ではこれら問題点の詳細を見ていく。
...
Wassertein GAN では、この勾配消失問題を回避するために、Earth-Mover距離（Wassertein距離）を使用するが、<br>
...
![image](https://user-images.githubusercontent.com/25688193/56465679-2fd85480-643d-11e9-8ec3-6c0af71d327c.png)<br>

> 記載中...

これらのことを踏まえると、Earth-Mover距離（Wassertein距離）は、以下のような式で定義できる。<br>

![image](https://user-images.githubusercontent.com/25688193/56465680-41b9f780-643d-11e9-92d3-6e64fc790e86.png)<br>
