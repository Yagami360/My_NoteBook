...
1. image-to-image
    ...
    1. [【非公開（外部リンク）】SPADE [Semantic Image Synthesis with Spatially-Adaptive Normalization]](https://github.com/Yagami360/My_Notebook_Private/blob/master/SPADE.md)
1. セマンティック・セグメンテーション
    1. [【非公開（外部リンク）】Graphonomy [Universal Human Parsing via Graph Transfer Learning]](https://github.com/Yagami360/My_Notebook_Private/blob/master/Graphonomy.md)
1. Inpainting
...
1. 仮想試着システム [Virtual Try-On]
    ...
    1. 【非公開】MG-VTON [Towards_Multi-pose_Guided_Virtual_Try-on_Network]
    1. 【非公開】[WUTON] End-to-End Learning of Geometric Deformations of Feature Maps for Virtual Try-On
1. text-to-image
