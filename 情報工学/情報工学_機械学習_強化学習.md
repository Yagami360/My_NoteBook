...
1. [ベルマン方程式](#ベルマン方程式)
1. [マルコフ決定過程を解くための動的最適化法](#マルコフ決定過程を解くための動的最適化法)
...
## ■ マルコフ決定過程を解くための動的計画法
先のベルマンの方程式<br>
![image](https://user-images.githubusercontent.com/25688193/49986762-57617100-ffb4-11e8-907b-3f38e9f502f9.png)<br>
は、価値関数に対しての不動点方程式となっており、この不動点方程式が導く不動点としての最適価値関数の存在の一意性は、価値反復法 [value iteration] や方策反復法 [policy iteration] と呼ばれる動的計画法のアルゴリズムで、最適解が得られることの根拠となる。<br>
...
![image](https://user-images.githubusercontent.com/25688193/49986981-1d449f00-ffb5-11e8-84f9-0a2919090baf.png)<br>
...
反復法には、それぞれ価値反復法と政策反復法が存在するが、両者の違いは、価値関数の更新方針の違いにある。即ち、<br>

- 価値反復法では、価値関数の更新方針は、グリーディーな方策（＝価値関数をmax化する行動）に基づく更新を行う。<br>
- 政策反復法では、xxx<br>
...
### ◎ 価値反復法
![image](https://user-images.githubusercontent.com/25688193/49987102-7e6c7280-ffb5-11e8-94e3-a9c103a77418.png)<br>
![image](https://user-images.githubusercontent.com/25688193/49987154-ad82e400-ffb5-11e8-8fe3-438d302da918.png)<br>
![image](https://user-images.githubusercontent.com/25688193/49987188-c8edef00-ffb5-11e8-9175-042ca6d8a12c.png)<br>
