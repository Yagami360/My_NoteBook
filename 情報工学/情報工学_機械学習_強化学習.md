...
そして、エピソードの更新（＝行動選択）は、下図のように、ε-greedy 手法に従った行動方策によって行う。<br>

![image](https://user-images.githubusercontent.com/25688193/50381332-a64f8a80-06c7-11e9-9cb0-e91e919d513a.png)<br>

この Sarsa は、ε-greedy な行動方策によってエピソードの更新（＝行動選択）が行われ、それに伴って次の状態 s',a' が定まり、価値関数の更新が行われることになる。<br>
言い換えると、エピソードの更新（＝行動選択）と価値関数の更新が、共に ε-greedy な行動方策に従って行われる。（上図参照）<br>
このような制御手法を、方策オン型TD制御という。<br>

<br>

この Sarsa をアルゴリズムとしてまとめると、以下のようになる。<br>

![image](https://user-images.githubusercontent.com/25688193/50382977-1f61d880-06ee-11e9-9cf9-feb16132a3ac.png)<br>
